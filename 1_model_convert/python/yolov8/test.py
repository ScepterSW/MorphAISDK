...
from py_utils.yolov8_postprocess import *
import numpy as np

# the path of rknn model file
MODEL_FILE_PATH = curdir_ + './out/yolov8n_precompile.rknn'
...
if __name__ == '__main__':
    ...
    # postprocess
    boxes, classes, scores = post_process(outputs, img.shape, config.obj_thresh, config.nms_thresh)
