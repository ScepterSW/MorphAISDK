...
def box_process(position, image_size):
...
def post_process(input_data, image_size, obj_thresh, nms_thresh):
    boxes, scores, classes_conf = [], [], []
    defualt_branch=3
    pair_per_branch = len(input_data)//defualt_branch
    # Python ignores the score_sum output
    for i in range(defualt_branch):
        boxes.append(box_process(input_data[pair_per_branch*i], image_size))
